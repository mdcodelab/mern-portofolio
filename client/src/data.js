...
export const data = [
  ...
  },
  {
    ...
    urlDemo: "https://workwavehub-jobs-platform.onrender.com/dashboard",
    urlGit: "https://github.com/mdcodelab/WorkWaveHub-jobs-platform-MERN",
    description:
      "The app empowers users to create, post, and manage their job listings. With full CRUD functionality, users can seamlessly interact with job postings. Each user enjoys a personalized profile, enhancing the overall job-seeking experience.",
